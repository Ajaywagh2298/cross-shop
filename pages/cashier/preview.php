...
<link rel="shortcut icon" href="cross%20shop.JPG">
...
<script language="javascript">
	...
	{ 
		var disp_setting="toolbar=yes,location=no,directories=yes,menubar=yes,layout=landscape";
		disp_setting+="scrollbars=yes,width=800, height=400, left=100, top=25";
		var content_vlue = document.getElementById("print").innerHTML;

		var docprint=window.open("","",disp_setting); 
		docprint.document.open(content_vlue);
...
<div class="content" id="content">
	<div id= "print" style="margin: 0 auto; padding: 20px; width: 700px; font-weight: normal;">
        <p style="font-size: 30px;text-align: center;"> - MAA DURGA TRADERS - </p><br />
		<div style="width: 100%;">
...
<br><br>
			<div style="text-align: right; margin-top: 13px;">Signature : <?php echo $cashier ?></div>
        <p style="font-size: 14px;">Street Address: <br />
            City : Buxar <br>
            Contact No: 8540888028<br>
            Email Add : Akshayleo14@gmail.com<br></p>
		</div>
    <center><a class = "btn btn-primary" style="margin: 15px;" href="javascript:Clickheretoprint()" style="font-size:20px";>Print</a>&nbsp;&nbsp;<a class = "btn btn-primary" style="margin: 15px;" href="home.php" style="font-size:20px";>Back</a></center>
	</div>
