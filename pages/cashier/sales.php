        ...
        <div id="page-wrapper">
          <div class="row">
            ...
            <form action="incoming.php" method="post" class = "form-group" >
              ...
              <label>Goods Service Tax</label>
              <input type="text" name="vat" value="0" class = "form-control"  autocomplete="on" style="width: 100px; padding-top: 6px; padding-bottom: 6px; margin-right: 4px;" />
              <br>
