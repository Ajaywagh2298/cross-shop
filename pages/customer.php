...
<body>
    <?php include('cashier/navfixed.php'); ?>
    <?php
                                ...
                                <div class="modal-body">
                                    <form action="savecustomer.php" method="post" class = "form-group">
                                        <div id="ac">
                                            ...
                                            <span>Membership No. : </span><input type="text" value="<?php echo $pcode; ?>" name="memno" class = "form-control" />
